                ...
                {rtPlans.map(p => {
                  ...
                  return (
                    <tr key={p.id} className={`hover:bg-gray-50 ${!p.active ? 'opacity-50' : ''}`}>
                      ...
                      <td className="px-4 py-3 font-medium">{calc ? fmt(calc.sadc_total || calc.total_per_person) : '—'}</td>
                      <td className="px-4 py-3 text-teal">{calc ? fmt(calc.intl_total || calc.international_total) : '—'}</td>

...
export default function BookingDetail() {
    ...
    const timer = setTimeout(async () => {
      ...
      try {
        ...
        if (rate_plan_id) {
          ...
          params = new URLSearchParams({ room_type_id, check_in, check_out, adults, children: children || 0 });
        }
  ...
  }, [editForm.rate_plan_id, editForm.room_type_id, editForm.check_in, editForm.check_out, editForm.adults, editForm.children, editModal]);
